...
static inline int multiplayer_menu_init(void)
{
  return 0;
}
...
static inline void multiplayer_menu_set_state(int state)
{
  (void)state;
}
static inline void multiplayer_menu_show_error(const char *msg, uint32_t timeout)
{
  (void)msg;
  (void)timeout;
}
